В статье описана настройка сетевой связности между инфраструктурой on-premises и виртуальной сетью VK Cloud в [SDN Neutron](ru/networks/vnet/concepts/sdn#neutron).
